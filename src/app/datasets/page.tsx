  ...
  return (
    <>
      ...
      <article className="prose">
        ...
        <p>
          These datasets allow you to analyse the contents of PyPI without having to download and process every
          package yourself.
        </p>
      </article>
      ...
      <div className="card rounded-box bg-base-100 shadow-2xl">
        <div className="card-body">
          ...
          <article className="prose lg:prose-md">
            ...
            <p>
              The dataset should be accessed by downloading the files specified within <code>{DATASET_URL}</code>.
            ...
            <details className="collapse bg-base-200 mb-5 mt-5">
              ...
              <div className="collapse-content">
                <p className="mt-0">
                  ...
                  and
                  supports SQL queries over Parquet files. The following command uses DuckDB to find the largest file
                  ever
                  uploaded to PyPI:
                </p>
                <SyntaxHighlight language="shell">
                ...
                <p>That explains it. Very funny, if it is indeed a joke 😅</p>
              </div>
            </details>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="ml-5">
                  <p className="mt-0">
                    ...
                    repositories
                    then
                    the reason for skipping is recorded here. On the right is a list of the current skip reasons and the
                    number of
                  ...
                  <p>
                    ...
                    include
                    virtual environments accidentally uploaded to PyPI. <code>text-long-lines</code> means the file had
                    very
                ...
                <div>
                  ...
                  <ul>
                    {stats.skip_reason_stats.map((reason) => (
                      <li key={reason.skip_reason}>
                        <code>{reason.skip_reason}</code> - {reason.count.toLocaleString()} files
                      </li>
                    ))}
                  </ul>
                </div>
        ...
        <div className="card-body">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <h3>About</h3>
              <p>
                This dataset contains one row per <strong>unique</strong> Python file within every release uploaded to
                PyPI.
                Only the sha256 hash and a random path to the file is provided. This dataset is useful if you want to
                parse
      ...
      <div className="card rounded-box bg-base-100 shadow-2xl">
        <div className="card-body">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <h3>About</h3>
              <p>This is a SQLite dump of all PyPI metadata fetched from the PyPI API. It is updated daily.</p>
              <h3>Links</h3>
