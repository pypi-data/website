...
export default async function Page() {
    ...
    const chartData = data.stats_over_time.stat.sort((a, b) => a.month < b.month ? -1 : 1);
    ...
    return (
        <>
            <h1>Stats</h1>
            <TotalStats stats={data.total_stats.stat[0]} lastMonth={lastMonth}/>
            ...
            <StatsTable stats={data.skipped_files_stats.stat}/>

            <h1>Binary files</h1>
            <StatsTable stats={data.binary_extension_stats.stat}/>

            <h1>Stats By Extensions</h1>
            <StatsTable stats={data.extension_stats.stat}/>
