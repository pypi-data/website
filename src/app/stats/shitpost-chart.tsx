...
export default function ShitpostChart({chartData, extrapolated, years, future_value}: {
    chartData: any[],
    ...
    return (
        <>
            <div className="grid grid-cols-3 gap-1">
                <div>
                    <ChartScroll chartData={extrapolated.slice(0, extrapolatedIndex)}
                                 cumulative={true}
                                 showValueHeader={({new_releases}) => (Intl.NumberFormat('en-US', {
                                     notation: "compact",
                                     compactDisplay: "long",
                ...
                <div>
                    <ChartScroll chartData={extrapolated.slice(0, extrapolatedIndex)}
                                 cumulative={true}
                                 showValueHeader={({total_size}) => Intl.NumberFormat("en", {
                                     notation: "compact",
                                     style: "unit",
                                     unit: "byte",
                                     unitDisplay: "narrow",
                ...
                <div>
                    <ChartScroll chartData={extrapolated.slice(0, extrapolatedIndex)}
                                 cumulative={true}
                                 showValueHeader={({total_files}) => (Intl.NumberFormat('en-US', {
                                     notation: "compact",
                                     compactDisplay: "long",
            ...
            <h4 className={"text-center font-bold mb-3"}>
                PyPI is growing fast.
                If this dangerous expansion not stopped our advanced machine learning models predict that in
                only {years} years
                the number of packages will outnumber human beings {Math.round(packages_per_human)} to 1.
            </h4>
